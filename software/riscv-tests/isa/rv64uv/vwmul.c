...
void TEST_CASE1(void) {
  VSET(16, e8, m2);
  VLOAD_8(v4, 0xee, 0xfe, 0xbd, 0xc2, 0x02, 0xa4, 0x34, 0x33, 0x2b, 0x35, 0x16,
          0x9b, 0x3b, 0x5f, 0xfc, 0x8b);
  VLOAD_8(v8, 0xcb, 0x24, 0xe8, 0xb2, 0xeb, 0x24, 0x80, 0x67, 0x43, 0x11, 0x7c,
          0x94, 0x22, 0x71, 0xca, 0x80);
  asm volatile("vwmul.vv v6, v4, v8");
  VSET(16, e16, m2);
  ...
  VSET(16, e32, m2);
  VLOAD_32(v4, 0xbbc467cb, 0xfbb3efda, 0x652f8490, 0x5e7ea848, 0x21fbc400,
           0xbb409fde, 0x98413836, 0x14652ba4, 0xc3d3c86f, 0xc84d3ae3,
           0x3df53027, 0xbda29a2c, 0xa1d7d949, 0x60a3d06e, 0xa91e405d,
           0x7eea498f);
  VLOAD_32(v8, 0x80407791, 0x3e51b6e0, 0xd0be8bc1, 0x683f33bd, 0xeddda6c8,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v6);
  asm volatile("vwmul.vv v6, v4, v8, v0.t");
  VSET(16, e16, m2);
...
void TEST_CASE3(void) {
  VSET(16, e8, m2);
  VLOAD_8(v4, 0x86, 0x79, 0xa0, 0x8a, 0x3e, 0xc3, 0x3e, 0x0c, 0x1b, 0xca, 0x80,
          0x41, 0x0e, 0xee, 0x94, 0xdf);
  int64_t scalar = 5;
  asm volatile("vwmul.vx v6, v4, %[A]" ::[A] "r"(scalar));
  VSET(16, e16, m2);
  ...
  VSET(16, e32, m2);
  VLOAD_32(v4, 0x71c6753d, 0x66646cc2, 0x23065c23, 0xde594cad, 0xa2f87c53,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v6);
  asm volatile("vwmul.vx v6, v4, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e16, m2);

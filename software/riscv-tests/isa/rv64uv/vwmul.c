...
void TEST_CASE1(void) {
  VSET(16, e8, m8);
  VLOAD_8(v8, 0xee, 0xfe, 0xbd, 0xc2, 0x02, 0xa4, 0x34, 0x33, 0x2b, 0x35, 0x16,
          0x9b, 0x3b, 0x5f, 0xfc, 0x8b);
  VLOAD_8(v16, 0xcb, 0x24, 0xe8, 0xb2, 0xeb, 0x24, 0x80, 0x67, 0x43, 0x11, 0x7c,
          0x94, 0x22, 0x71, 0xca, 0x80);
  asm volatile("vwmul.vv v24, v8, v16");
  VSET(16, e16, m8);
  VCMP_I16(1, v24, 0x03ba, 0xffb8, 0x0648, 0x12e4, 0xffd6, 0xf310, 0xe600,
           0x1485, 0x0b41, 0x0385, 0x0aa8, 0x2a9c, 0x07d6, 0x29ef, 0x00d8,
           0x3a80);

  VSET(16, e16, m8);
  VLOAD_16(v8, 0x8aed, 0x2153, 0x5377, 0xc19c, 0x1051, 0x1b75, 0xbafd, 0xb200,
           0xb209, 0xa9a2, 0xbdc4, 0x1653, 0x5965, 0x145e, 0xb626, 0xd79c);
  VLOAD_16(v16, 0x778d, 0xc104, 0x6eac, 0x78e8, 0xacd2, 0x698b, 0xc7d3, 0x1e29,
           0x0a58, 0x58b5, 0x29f9, 0x2fb0, 0x2166, 0x0ac4, 0x44e5, 0xbc40);
  asm volatile("vwmul.vv v24, v8, v16");
  VSET(16, e32, m8);
  VCMP_I32(2, v24, 0xc953af89, 0xf7cd184c, 0x241535f4, 0xe2889560, 0xfab2ce72,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v24);
  asm volatile("vwmul.vv v24, v8, v16, v0.t");
  VSET(16, e16, m8);
  VCMP_I16(4, v24, 0, 0xffb8, 0, 0x12e4, 0, 0xf310, 0, 0x1485, 0, 0x0385, 0,
  ...
  asm volatile("vwmul.vv v24, v8, v16, v0.t");
  VSET(16, e32, m8);
  VCMP_I32(5, v24, 0, 0xf7cd184c, 0, 0xe2889560, 0, 0x0b51e587, 0, 0xf6cf8200,
...
void TEST_CASE3(void) {
  VSET(16, e8, m8);
  VLOAD_8(v8, 0x86, 0x79, 0xa0, 0x8a, 0x3e, 0xc3, 0x3e, 0x0c, 0x1b, 0xca, 0x80,
          0x41, 0x0e, 0xee, 0x94, 0xdf);
  unsigned int scalar = 5;
  asm volatile("vwmul.vx v24, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e16, m8);
  VCMP_I16(7, v24, 0xfd9e, 0x025d, 0xfe20, 0xfdb2, 0x0136, 0xfecf, 0x0136,
           0x003c, 0x0087, 0xfef2, 0xfd80, 0x0145, 0x0046, 0xffa6, 0xfde4,
           0xff5b);

  VSET(16, e16, m8);
  VLOAD_16(v8, 0xb0ab, 0xcccb, 0x5fad, 0x9e24, 0x1496, 0xd4a0, 0x2552, 0xcef6,
           0x34b8, 0xef22, 0x69c3, 0xbb05, 0xbe72, 0x315b, 0x3f03, 0xf58b);
  scalar = -5383;
  asm volatile("vwmul.vx v24, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e32, m8);
  VCMP_I32(8, v24, 0x06842453, 0x0434bf73, 0xf8243145, 0x0809b904, 0xfe4f21e6,
  ...
  asm volatile("vwmul.vx v24, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_I64(9, v24, 0x002be7b6249483ff, 0x0027833479d82816, 0x000d840f6a940f21,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vwmul.vx v24, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e16, m8);
  VCMP_I16(10, v24, 0, 0x025d, 0, 0xfdb2, 0, 0xfecf, 0, 0x003c, 0, 0xfef2, 0,
  ...
  asm volatile("vwmul.vx v24, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e32, m8);
  VCMP_I32(11, v24, 0, 0x0434bf73, 0, 0x0809b904, 0, 0x03900fa0, 0, 0x04072946,
  ...
  asm volatile("vwmul.vx v24, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_I64(12, v24, 0, 0x0027833479d82816, 0, 0xfff303a4936737cf, 0,

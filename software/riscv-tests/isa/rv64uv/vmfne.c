...
void TEST_CASE1(void) {
  ...
  VLOAD_32(v4, 0x00000000, 0xffffffff, 0xbeb162ab, 0xbd7edebf, 0x3f75db3c,
  ...
  VLOAD_32(v6, 0x80000000, 0xffffffff, 0x3ec9be30, 0xbf518bb7, 0x3e7c7a73,
  ...
  //              -0.7793965434104730
  VLOAD_64(v6, 0xbfd6ccd13852f170, 0xbf8bc6e7ac263f80, 0x3fed8915c5665532,
...
void TEST_CASE2(void) {
  ...
  //               -0.30920035, -0.31596854, -0.92116749,  0.51336122,
  //               0.22002794,  0.48599416,  0.69166088,  0.85755372
  VLOAD_32(v4, 0x00000000, 0x3dcb7174, 0xbeb162ab, 0xbd7edebf, 0x3f75db3c,
           0xbf4f6872, 0xbf3180f6, 0x3f3464fe, 0xbe9e4f82, 0xbea1c6a1,
           0xbf6bd1a2, 0x3f036ba4, 0x3e614f01, 0x3ef8d43a, 0x3f3110b0,
           0x3f5d88a4);
  ...
  VLOAD_32(v6, 0x00000000, 0xbf25d7d9, 0x3ec9be30, 0xbf518bb7, 0x3e7c7a73,
           0xbf36d819, 0xbee50bcd, 0xbe829d5c, 0xbf719c37, 0xbe9a4fa3,
           0x3e447c62, 0xbe96125b, 0xbe6b5444, 0xbf16155f, 0xbf4f238f,
           0x3f5d88a4);
  VLOAD_8(v0, 0xAA, 0xAA);
  ...
  //               0.6962970677624296,  0.7585780695949504, -0.5927175227484118,
  //               -0.7793965434104730
  VLOAD_64(v6, 0x3feba8d9296c7e74, 0x3fdefda0947f3460, 0x3fed8915c5665532,
...
void TEST_CASE3(void) {
  ...
  asm volatile("vmfne.vf v2, v4, %[A]" ::[A] "f"(fscalar_16));
  VSET(1, e16, m2);
  ...
  VLOAD_32(v4, 0xbe1fc17c, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038, 0x3f4e2038,
  ...
  VLOAD_64(v4, 0x3fec543182780b14, 0xbfc33a041b62e250, 0xbfe8f9623feb8e20,
           ...
           0xbfe01c2a245f7960);
  asm volatile("vmfne.vf v2, v4, %[A]" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(9, v2, 0xfff7);
};
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfne.vf v2, v4, %[A], v0.t" ::[A] "f"(fscalar_16));
  VSET(1, e16, m2);
  ...
  //                -0.79952192, -0.03668820, -0.38464722, -0.54745716,
  //                0.09956384,  0.21655059, -0.37557366, -0.79342169
  VLOAD_32(v4, 0x3f4e2038, 0x3f4e2038, 0xbe967703, 0x3f7c66bb, 0x3f61b2e8,
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfne.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(12, v2, 0xaaa2);
};
...
void TEST_CASE5(void) {
  // Fill 64-bits with 1
  VSET(1, e64, m2);
  VLOAD_64(v2, 0xffffffffffffffff);
  ...
  //               0.0987,  0.1777,  0.3047,  0.2330, -0.3467, -0.4153,  0.7080,
  //               0.3142, -0.9492
  VLOAD_16(v6, 0x33ca, 0x2b8c, 0x3a13, 0xb949, 0xb79d, 0x3ad3, 0x29cc, 0x2e51,
           0x31b0, 0x34e0, 0x3375, 0xb58c, 0xb6a5, 0x39aa, 0x3041, 0xbb98);
  asm volatile("vmfne.vv v2, v4, v6");
  VSET(1, e64, m2);
  VCMP_U64(13, v2, 0xfffffffffffffffe);
  ...
  //              -0.30920035, -0.31596854, -0.92116749,  0.51336122,
  //              0.22002794,  0.48599416,  0.69166088,  0.85755372
  VLOAD_32(v4, 0x70000000, 0xffffffff, 0xbeb162ab, 0xbd7edebf, 0x3f75db3c,
           0xbf4f6872, 0xbf3180f6, 0x3f3464fe, 0xbe9e4f82, 0xbea1c6a1,
           0xbf6bd1a2, 0x3f036ba4, 0x3e614f01, 0x3ef8d43a, 0x3f3110b0,
           0x3f5b88a4);
  ...
  //               -0.94378990, -0.30138883,  0.19188073, -0.29310879,
  //               -0.22981364, -0.58626360, -0.80913633, -0.00670803
  VLOAD_32(v6, 0x80000000, 0xffffffff, 0xbeb162ab, 0xbf518bb7, 0x3e7c7a73,
           0xbf36d819, 0xbee50bcd, 0xbe829d5c, 0xbf719c37, 0xbe9a4fa3,
           0x3e447c62, 0xbe96125b, 0xbe6b5444, 0xbf16155f, 0xbf4f238f,
           0xbbdbcefe);
  asm volatile("vmfne.vv v2, v4, v6");
  VSET(1, e64, m2);
  VCMP_U64(14, v2, 0xfffffffffffffffb);
  ...
  //               -0.3032110323317654,  0.8998114670494881, 0.6283940115157876,
  //               0.1053912590957002, -0.2936564640984622,  0.4329957213663693
  VLOAD_64(v4, 0x3feba8d9296c7e74, 0x3fdefda0947f3460, 0xbf3180f63f75db3c,
           0xbfee55c27d3d743e, 0xbfc0c0dbc6990b38, 0xbfd84eacd38c6ca4,
           0x3fc41b3c98507fe0, 0xbfe8877fabcbce12, 0xbfd7e9bb5b0beaf8,
           0x3fdfa988fd8b0a24, 0xbfd367cf3ee9af68, 0x3feccb416af162fc,
           0x3fe41bcdc20ecd40, 0x3fbafaebeb19acf0, 0xbfd2cb447b63f610,
  ...
  //               0.6962970677624296,  0.7585780695949504, -0.5927175227484118,
  //               -0.7793965434104730
  VLOAD_64(v6, 0x3feba8d9296c7e74, 0xbf8bc6e7ac263f80, 0x3fed8915c5665532,
           0x3fef0d4f6aafa2f6, 0xbfb748c1c20f5de0, 0xbfbb114c0f1ff4b0,
           0xbfec227053ec5198, 0xbfc6563348637140, 0x3fd3e7f302d586b4,
           0x3fd4bac177803510, 0xbfed0dc20130d694, 0xbfee5ef3f3ff6a12,
           0x3fe64810c9cae3fe, 0x3fe84645840bf0a2, 0xbfe2f78abcff0ede,
  ...
  asm volatile("vmfne.vv v2, v4, v6");
  VSET(1, e64, m2);
  VCMP_U64(15, v2, 0xfffffffffffffffe);
};
...
void TEST_CASE6(void) {
  ...
  VLOAD_32(v6, 0x00000000, 0x3dcb7174, 0x3ec9be30, 0xbf518bb7, 0x3f75db3c,
  ...
  VLOAD_64(v6, 0x3feba8d9296c7e74, 0x3fdefda0947f3460, 0xbfec227053ec5198,
...
void TEST_CASE7(void) {
  ...
  VSET(16, e32, m2);
  VLOAD_32(v4, 0x3f75db3c, qNaNf, qNaNf, qNaNf, 0x3f75db3c, 0xbf4f6872,
           0xbf3180f6, 0x3f3464fe, 0xbe9e4f82, 0xbea1c6a1, 0xbf6bd1a2,
           0x3f036ba4, qNaNf, qNaNf, 0x3f3110b0, qNaNf);
  VLOAD_32(v6, 0x3f75db3c, 0x3dcb7174, qNaNf, 0xbf518bb7, 0x3f75db3c,
           0xbf4f6872, 0xbee50bcd, 0xbe829d5c, 0xbe9e4f82, 0xbea1c6a1,
  ...
  VSET(16, e64, m2);
  VLOAD_64(v4, qNaNd, qNaNd, 0x3fed8915c5665532, 0xbfec227053ec5198,
  ...
  VLOAD_64(v6, qNaNd, 0x3fdefda0947f3460, qNaNd, 0x9fee55c27d3d743e,
  ...
  VSET(16, e32, m2);
  VLOAD_32(v4, 0x3f75db3c, sNaNf, sNaNf, qNaNf, 0x3f75db3c, 0xbf4f6872,
           0xbf3180f6, 0x3f3464fe, 0xbe9e4f82, 0xbea1c6a1, 0xbf6bd1a2,
           0x3f036ba4, qNaNf, qNaNf, 0x3f3110b0, qNaNf);
  VLOAD_32(v6, 0x3f75db3c, 0x3dcb7174, qNaNf, 0xbf518bb7, 0x3f75db3c,
           0xbf4f6872, 0xbee50bcd, 0xbe829d5c, 0xbe9e4f82, 0xbea1c6a1,

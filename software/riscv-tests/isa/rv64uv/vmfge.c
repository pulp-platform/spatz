...
void TEST_CASE1(void) {
  ...
  asm volatile("vmfge.vf v2, v4, %[A]" ::[A] "f"(fscalar_16));
  VSET(1, e16, m2);
  ...
  VLOAD_64(v4, 0x3fec543182780b14, 0xbfc33a041b62e250, 0xbfe8f9623feb8e20,
           ...
           0xbfe01c2a245f7960);
  asm volatile("vmfge.vf v2, v4, %[A]" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(3, v2, 0x4f7b);
};
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v2);
  asm volatile("vmfge.vf v2, v4, %[A], v0.t" ::[A] "f"(fscalar_16));
  VSET(1, e16, m2);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfge.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(6, v2, 0x0a2a);
};

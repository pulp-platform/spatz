...
void TEST_CASE1(void) {
  VSET(16, e8, m2);
  VLOAD_8(v4, 0x74, 0xfb, 0xf4, 0xe9, 0xe5, 0x4e, 0x02, 0x27, 0xe9, 0x83, 0xfe,
          0x03, 0xb2, 0xb9, 0x9a, 0x71);
  VLOAD_8(v8, 0x67, 0xa9, 0x07, 0x0f, 0xe3, 0x0d, 0xce, 0x81, 0xa2, 0xa5, 0x59,
          0x18, 0x0d, 0xac, 0x80, 0x31);
  asm volatile("vwmulu.vv v6, v4, v8");
  VSET(16, e16, m2);
  ...
  VSET(16, e32, m2);
  VLOAD_32(v4, 0xd6f59ab7, 0x3b760112, 0x185928a9, 0x344f2f98, 0x07084e45,
           0x0af492c5, 0x5de6f51a, 0x76783522, 0x36835490, 0x043d016f,
           0xf583b765, 0xd8796652, 0x1bd09e8f, 0xeecf0026, 0xdb725a7d,
           0x3a4c3ab3);
  VLOAD_32(v8, 0x19f9f18b, 0x801fde9f, 0xaf759e4c, 0x9206cfd4, 0x2dc70e82,
...
void TEST_CASE2(void) {
  ...
  VCLEAR(v6);
  asm volatile("vwmulu.vv v6, v4, v8, v0.t");
  VSET(16, e16, m2);
...
void TEST_CASE3(void) {
  VSET(16, e8, m2);
  VLOAD_8(v4, 0xf8, 0x11, 0x12, 0xf1, 0x63, 0x21, 0x88, 0x3b, 0x01, 0xf5, 0x6d,
          0xf5, 0xb1, 0x54, 0xcd, 0xb0);
  uint64_t scalar = 5;
  asm volatile("vwmulu.vx v6, v4, %[A]" ::[A] "r"(scalar));
  VSET(16, e16, m2);
  ...
  VSET(16, e32, m2);
  VLOAD_32(v4, 0xc41bf344, 0xad5aef4c, 0xf2b11789, 0xeb0d7526, 0xd6c67427,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v6);
  asm volatile("vwmulu.vx v6, v4, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e16, m2);

...
void TEST_CASE2(void) {
  ...
  VCMP_U16(3, v1, 0, 0x3501, 0, 0xab30, 0, 0x3170, 0, 0x34c8, 0, 0xba74, 0,
  ...
  VCLEAR(v1);
  asm volatile("vfadd.vv v1, v2, v3, v0.t");
  VCMP_U32(4, v1, 0, 0x3f849b47, 0, 0x3fb2b95a, 0, 0xbf369ead, 0, 0xbc873468, 0,
...
void TEST_CASE3(void) {
  ...
  asm volatile("vfadd.vv v1, v2, v3");
  VCMP_U16(5, v1, qNaNh, pInfh, mInfh, qNaNh, pInfh, pZero, pZero, mZeroh,
  ...
  asm volatile("vfadd.vv v1, v2, v3");
  VCMP_U32(6, v1, qNaNf, pInff, mInff, qNaNf, pInff, pZero, pZero, mZerof,
...
void TEST_CASE4(void) {
  ...
  VLOAD_16(v3, pMaxh, pMaxh, pMaxh, pMaxh, pMaxh, pMaxh, pMaxh, pMaxh, pMaxh,
           pMaxh, pMaxh, pMaxh, pMaxh, pMaxh, pMaxh, pMaxh);
  asm volatile("vfadd.vv v1, v2, v3");
  VCMP_U16(7, v1, pInfh, pInfh, pInfh, pInfh, pInfh, pInfh, pInfh, pInfh,
  ...
  asm volatile("vfadd.vv v1, v2, v3");
  VCMP_U32(8, v1, qNaNf, qNaNf, qNaNf, qNaNf, qNaNf, qNaNf, qNaNf, qNaNf,
...
void TEST_CASE5(void) {
  ...
  //              0.2988,  0.0869, -0.8066, -0.4131,  0.6816,  0.5801,  0.1326,
  //              -0.1708,  0.7412
  VCMP_U16(9, v1, 0xbed3, 0x3501, 0x3439, 0xab30, 0xb02b, 0x3170, 0x38f2,
  ...
  //              0.2988,  0.0869, -0.8066, -0.4131,  0.6816,  0.5801,  0.1326,
  //              -0.1708,  0.7412
  VCMP_U16(10, v1, 0xbed3, 0x3501, 0x3439, 0xab30, 0xb02b, 0x3170, 0x38f2,
           0x34c8, 0x2d90, 0xba74, 0xb69c, 0x3974, 0x38a4, 0x303e, 0xb177,
           0x800f);
};
...
void TEST_CASE6(void) {
  ...
  VCMP_U16(11, v1, 0xbc58, 0xbc78, 0xbdef, 0xb8ec, 0xb8ea, 0xbea3, 0xbdd4,
  ...
  VCMP_U32(12, v1, 0xbdc2e718, 0xbfbff9f6, 0xbfb746d8, 0x3d037480, 0xbf23a7dc,
...
void TEST_CASE7(void) {
  ...
  VCMP_U16(13, v1, 0, 0xbc78, 0, 0xb8ec, 0, 0xbea3, 0, 0xbd8d, 0, 0xb2a8, 0,
  ...
  VCMP_U32(14, v1, 0, 0xbfbff9f6, 0, 0x3d037480, 0, 0xbfb78aa0, 0, 0xbf044152,
...
void TEST_CASE8(void) {
  ...
  VCLEAR(v1);
  asm volatile("vfadd.vv v1, v2, v3, v0.t");
  VCMP_U16(15, v1, 0, pInfh, 0, pInfh, 0, pInfh, 0, pInfh, 0, pInfh, 0, pInfh,
           0, pInfh, 0, pInfh);
  CHECK_FFLAGS(OF | NX);
  ...
  VCLEAR(v1);
  asm volatile("vfadd.vv v1, v2, v3, v0.t");
  VCMP_U32(16, v1, 0, qNaNf, 0, qNaNf, 0, qNaNf, 0, qNaNf, 0, qNaNf, 0, qNaNf,
           0, qNaNf, 0, qNaNf);
  CHECK_FFLAGS(NV);
};

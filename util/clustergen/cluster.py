...
// instead."""
    ...
    templates = TemplateLookup(directories=[spatz_cluster_folder],
...
class SnitchCluster(Generator):
    ...
    def memory_cfg(self):
        ...
        self.add_mem(self.cfg['icache']['depth'],
    ...
    def calc_cache_sizes(self):
        ...
        self.cfg['icache']['depth'] = self.cfg['icache']['size'] * 1024 // self.cfg['icache']['sets'] // cl_bytes
        # tag width
        self.tag_width = self.cfg['addr_width'] - clog2(self.cfg['icache']['cacheline'] // 8) - clog2(self.cfg['icache']['depth']) + 3

...
package riscv_instr;
  ...
  localparam [31:0] HINVAL_VVMA        = 32'b0011011??????????000000001110011;
  localparam [31:0] HINVAL_GVMA        = 32'b0111011??????????000000001110011;
  ...
  localparam [31:0] BITREV             = 32'b1110011??????????000?????1110111;
  localparam [31:0] BITREVI            = 32'b111010???????????000?????1110111;
  localparam [31:0] BPICK              = 32'b?????00??????????011?????1110111;
  ...
  localparam [31:0] CLO8               = 32'b101011100011?????000?????1110111;
  localparam [31:0] CLO16              = 32'b101011101011?????000?????1110111;
  localparam [31:0] CLO32              = 32'b101011111011?????000?????1110111;
  ...
  localparam [31:0] MAXW               = 32'b1111001??????????000?????1110111;
  localparam [31:0] MINW               = 32'b1111000??????????000?????1110111;
  ...
  localparam [31:0] SWAP8              = 32'b101011011000?????000?????1110111;
  ...
  localparam [31:0] WEXTI              = 32'b1101111??????????000?????1110111;
  localparam [31:0] WEXT               = 32'b1100111??????????000?????1110111;
  ...
  localparam [31:0] PKBB32             = 32'b0000111??????????010?????1110111;
  localparam [31:0] PKBT32             = 32'b0001111??????????010?????1110111;
  localparam [31:0] PKTT32             = 32'b0010111??????????010?????1110111;

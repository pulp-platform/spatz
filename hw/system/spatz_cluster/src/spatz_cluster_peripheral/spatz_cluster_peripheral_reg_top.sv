...
module spatz_cluster_peripheral_reg_top #(
  ...
  always_comb begin
    ...
    addr_hit[ 2] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_2_OFFSET);
    addr_hit[ 3] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_3_OFFSET);
    addr_hit[ 4] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_4_OFFSET);
    addr_hit[ 5] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_5_OFFSET);
    addr_hit[ 6] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_6_OFFSET);
    addr_hit[ 7] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_7_OFFSET);
    addr_hit[ 8] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_8_OFFSET);
    addr_hit[ 9] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_9_OFFSET);
    addr_hit[10] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_10_OFFSET);
    addr_hit[11] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_11_OFFSET);
    addr_hit[12] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_12_OFFSET);
    addr_hit[13] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_13_OFFSET);
    addr_hit[14] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_14_OFFSET);
    addr_hit[15] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_ENABLE_15_OFFSET);
    addr_hit[16] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_0_OFFSET);
    addr_hit[17] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_1_OFFSET);
    addr_hit[18] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_2_OFFSET);
    addr_hit[19] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_3_OFFSET);
    addr_hit[20] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_4_OFFSET);
    addr_hit[21] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_5_OFFSET);
    addr_hit[22] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_6_OFFSET);
    addr_hit[23] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_7_OFFSET);
    addr_hit[24] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_8_OFFSET);
    addr_hit[25] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_9_OFFSET);
    addr_hit[26] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_10_OFFSET);
    addr_hit[27] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_11_OFFSET);
    addr_hit[28] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_12_OFFSET);
    addr_hit[29] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_13_OFFSET);
    addr_hit[30] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_14_OFFSET);
    addr_hit[31] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HART_SELECT_15_OFFSET);
    addr_hit[32] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_0_OFFSET);
    addr_hit[33] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_1_OFFSET);
    addr_hit[34] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_2_OFFSET);
    addr_hit[35] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_3_OFFSET);
    addr_hit[36] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_4_OFFSET);
    addr_hit[37] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_5_OFFSET);
    addr_hit[38] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_6_OFFSET);
    addr_hit[39] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_7_OFFSET);
    addr_hit[40] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_8_OFFSET);
    addr_hit[41] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_9_OFFSET);
    addr_hit[42] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_10_OFFSET);
    addr_hit[43] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_11_OFFSET);
    addr_hit[44] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_12_OFFSET);
    addr_hit[45] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_13_OFFSET);
    addr_hit[46] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_14_OFFSET);
    addr_hit[47] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_PERF_COUNTER_15_OFFSET);
    addr_hit[48] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_CL_CLINT_SET_OFFSET);
    addr_hit[49] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_CL_CLINT_CLEAR_OFFSET);
    addr_hit[50] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_HW_BARRIER_OFFSET);
    addr_hit[51] = (reg_addr == SPATZ_CLUSTER_PERIPHERAL_ICACHE_PREFETCH_ENABLE_OFFSET);
  end

...
package riscv_instr;
  localparam logic [31:0] AGETTYP            = 32'b000000100000000??101?????1011011;
  localparam logic [31:0] MGETTYP            = 32'b000001000000?????101?????1011011;
  localparam logic [31:0] ASETTYP            = 32'b000001100000?????00100??01011011;
  localparam logic [31:0] MSETTYP            = 32'b000010000000?????101?????1011011;
  localparam logic [31:0] MABS_EW            = 32'b000000000000?????100?????1011011;
  localparam logic [31:0] MEXP2_EW           = 32'b000010100000?????100?????1011011;
  localparam logic [31:0] MLOG2_EW           = 32'b000011000000?????100?????1011011;
  localparam logic [31:0] MBCAST_X           = 32'b000011100000?????001?????1011011;
  localparam logic [31:0] MCONV_EW           = 32'b000100000000?????101?????1011011;
  localparam logic [31:0] MCOLUNZIP_EW       = 32'b000100110000?????100?????1011011;
  localparam logic [31:0] MCOLZIP_EW         = 32'b000101000000?????100?????1011011;
  localparam logic [31:0] MROWUNZIP_EW       = 32'b000101110000?????100?????1011011;
  localparam logic [31:0] MADD_EW            = 32'b0000000??????????000?????1011011;
  localparam logic [31:0] MSUB_EW            = 32'b1000000??????????000?????1011011;
  localparam logic [31:0] MMUL_EW            = 32'b0011100??????????000?????1011011;
  localparam logic [31:0] MABSDIFF_EW        = 32'b0010000??????????000?????1011011;
  localparam logic [31:0] MAND_EW            = 32'b1110000??????????000?????1011011;
  localparam logic [31:0] MOR_EW             = 32'b1001000??????????000?????1011011;
  localparam logic [31:0] MXOR_EW            = 32'b1101000??????????000?????1011011;
  localparam logic [31:0] MANDNOT_EW         = 32'b0001000??????????000?????1011011;
  localparam logic [31:0] MORNOT_EW          = 32'b0101000??????????000?????1011011;
  localparam logic [31:0] MMAX_EW            = 32'b1010000??????????000?????1011011;
  localparam logic [31:0] MMIN_EW            = 32'b0110000??????????000?????1011011;
  localparam logic [31:0] MMEAN_EW           = 32'b0100000??????????000?????1011011;
  localparam logic [31:0] MHDIFF_EW          = 32'b1100000??????????000?????1011011;
  localparam logic [31:0] MGATHER_EW         = 32'b0001100??????????000?????1011011;
  localparam logic [31:0] MROWZIP_EW         = 32'b1101100??????????000?????1011011;
  localparam logic [31:0] MADD_EW_X          = 32'b0000000??????????010?????1011011;
  localparam logic [31:0] MSUB_EW_X          = 32'b1000000??????????010?????1011011;
  localparam logic [31:0] MMUL_EW_X          = 32'b0100100??????????010?????1011011;
  localparam logic [31:0] MABSDIFF_EW_X      = 32'b1010000??????????010?????1011011;
  localparam logic [31:0] MAND_EW_X          = 32'b1110000??????????010?????1011011;
  localparam logic [31:0] MOR_EW_X           = 32'b1001000??????????010?????1011011;
  localparam logic [31:0] MXOR_EW_X          = 32'b1101000??????????010?????1011011;
  localparam logic [31:0] MANDNOT_EW_X       = 32'b0001000??????????010?????1011011;
  localparam logic [31:0] MORNOT_EW_X        = 32'b0101000??????????010?????1011011;
  localparam logic [31:0] MMAX_EW_X          = 32'b1100000??????????010?????1011011;
  localparam logic [31:0] MMIN_EW_X          = 32'b0100000??????????010?????1011011;
  localparam logic [31:0] MMEAN_EW_X         = 32'b0010000??????????010?????1011011;
  localparam logic [31:0] MHDIFF_EW_X        = 32'b0110000??????????010?????1011011;
  localparam logic [31:0] MCMPGE_EW          = 32'b0011000??????????000?????1011011;
  localparam logic [31:0] MCMPLT_EW          = 32'b1011000??????????000?????1011011;
  localparam logic [31:0] MCMPGE_EW_X        = 32'b0011000??????????010?????1011011;
  localparam logic [31:0] MCMPLT_EW_X        = 32'b1011000??????????010?????1011011;
  localparam logic [31:0] MCMOVGE_EW         = 32'b0000100??????????000?????1011011;
  localparam logic [31:0] MCMOVLT_EW         = 32'b1000100??????????000?????1011011;
  localparam logic [31:0] MSELGE_EW          = 32'b0111000??????????000?????1011011;
  localparam logic [31:0] MSELLT_EW          = 32'b1111000??????????000?????1011011;
  localparam logic [31:0] MMULACC_EW         = 32'b1011100??????????000?????1011011;
  localparam logic [31:0] MMULACCNEG_EW      = 32'b0000010??????????000?????1011011;
  localparam logic [31:0] MMULADD_EW         = 32'b0111100??????????000?????1011011;
  localparam logic [31:0] MMULSUB_EW         = 32'b1111100??????????000?????1011011;
  localparam logic [31:0] MMULACC_EW_X       = 32'b1100100??????????010?????1011011;
  localparam logic [31:0] MMULACCNEG_EW_X    = 32'b0110100??????????010?????1011011;
  localparam logic [31:0] MMULADD_EW_X       = 32'b0010100??????????010?????1011011;
  localparam logic [31:0] MMULSUB_EW_X       = 32'b1010100??????????010?????1011011;
  localparam logic [31:0] MMULNEG_EW         = 32'b1000010??????????000?????1011011;
  localparam logic [31:0] MMULNEG_EW_X       = 32'b1110100??????????010?????1011011;
  localparam logic [31:0] MLOG2SUB_EW        = 32'b0110100??????????000?????1011011;
  localparam logic [31:0] MSUBLOG2_EW        = 32'b1110100??????????000?????1011011;
  localparam logic [31:0] MLOG2SUB_EW_X      = 32'b0111000??????????010?????1011011;
  localparam logic [31:0] MSUBLOG2_EW_X      = 32'b1111000??????????010?????1011011;
  localparam logic [31:0] MLDEXP_EW          = 32'b0100100??????????000?????1011011;
  localparam logic [31:0] MRDEXP_EW          = 32'b0010100??????????000?????1011011;
  localparam logic [31:0] MLDEXP_EW_X        = 32'b0000100??????????010?????1011011;
  localparam logic [31:0] MLDEXPACC_EW       = 32'b1100100??????????000?????1011011;
  localparam logic [31:0] MRDEXPACC_EW       = 32'b1010100??????????000?????1011011;
  localparam logic [31:0] MLDEXPACC_EW_X     = 32'b1000100??????????010?????1011011;
  localparam logic [31:0] MSHIFT_EW          = 32'b00000????????????011?????1011011;
  localparam logic [31:0] MPREFIXADD_ROW     = 32'b000110001000?????100?????1011011;
  localparam logic [31:0] MPREFIXADD_COL     = 32'b000110111000?????100?????1011011;
  localparam logic [31:0] MPREFIXMAX_ROW     = 32'b000111001000?????100?????1011011;
  localparam logic [31:0] MPREFIXMAX_COL     = 32'b000111111000?????100?????1011011;
  localparam logic [31:0] MREDUCEADD_ROW     = 32'b001000011100?????100?????1011011;
  localparam logic [31:0] MREDUCEADD_COL     = 32'b001000110100?????100?????1011011;
  localparam logic [31:0] MREDUCEMAX_ROW     = 32'b001001011100?????100?????1011011;
  localparam logic [31:0] MREDUCEMAX_COL     = 32'b001001110100?????100?????1011011;
  localparam logic [31:0] MSCATADD_COL       = 32'b0100010??????????000?????1011011;
  localparam logic [31:0] MSCATADD_ROW       = 32'b1001100??????????000?????1011011;
  localparam logic [31:0] MSCATMAX_COL       = 32'b1100010??????????000?????1011011;
  localparam logic [31:0] MSCATMAX_ROW       = 32'b0101100??????????000?????1011011;
  localparam logic [31:0] MMUL_2D            = 32'b0000000??????????11100??01011011;
  localparam logic [31:0] MMULACC_2D         = 32'b1000000??????????11100??01011011;
  localparam logic [31:0] MMULACCNEG_2D      = 32'b1100000??????????11100??01011011;
  localparam logic [31:0] MMULNEG_2D         = 32'b0100000??????????11100??01011011;
  localparam logic [31:0] MMULAT_2D          = 32'b0010000??????????11100??01011011;
  localparam logic [31:0] MMULATACC_2D       = 32'b1010000??????????11100??01011011;
  localparam logic [31:0] MMULBT_2D          = 32'b0110000??????????11100??01011011;
  localparam logic [31:0] MMULBTACC_2D       = 32'b1110000??????????11100??01011011;
  localparam logic [31:0] MZERO_2D           = 32'b0001111000000000000000??01011011;
  localparam logic [31:0] MMOV_A_M           = 32'b0011000000??00000001?????1011011;
  localparam logic [31:0] MMOV_M_M           = 32'b0100000?????00000001?????1011011;
  localparam logic [31:0] MLS                = 32'b000000100000?????110?????1011011;
  localparam logic [31:0] MLS_RM             = 32'b000000000000?????110?????1011011;
  localparam logic [31:0] MLS_CM             = 32'b000001000000?????110?????1011011;
  localparam logic [31:0] MSS                = 32'b001010000000?????110?????1011011;
  localparam logic [31:0] MSS_RM             = 32'b001100000000?????110?????1011011;
  localparam logic [31:0] MSS_CM             = 32'b000100000000?????110?????1011011;
  ...
  localparam logic [31:0] MSETMTYPE          = 32'b1000001??????????111000001010111;
  localparam logic [31:0] MSETTN             = 32'b100001000000?????111?????1010111;
  localparam logic [31:0] MSETTM             = 32'b100001000001?????111?????1010111;
  localparam logic [31:0] MSETTK             = 32'b100001000010?????111?????1010111;
  localparam logic [31:0] MSETMTYPEI         = 32'b1000010???11?????111000001010111;
  localparam logic [31:0] VTFMM_TVV          = 32'b1111001??????????001????01110111;
  localparam logic [31:0] VTFMM_ALT_TVV      = 32'b1111001??????????001????11110111;
  localparam logic [31:0] VTMMU_TVV          = 32'b1111001??????????000????01110111;
  localparam logic [31:0] VTMMS_TVV          = 32'b1111001??????????000????11110111;
  localparam logic [31:0] VTLE8              = 32'b0001001??????????111000000000111;
  localparam logic [31:0] VTLE16             = 32'b0011001??????????111000000000111;
  localparam logic [31:0] VTLE32             = 32'b0101001??????????111000000000111;
  localparam logic [31:0] VTLE64             = 32'b0111001??????????111000000000111;
  localparam logic [31:0] VTSE8              = 32'b0001001??????????111000000100111;
  localparam logic [31:0] VTSE16             = 32'b0011001??????????111000000100111;
  localparam logic [31:0] VTSE32             = 32'b0101001??????????111000000100111;
  localparam logic [31:0] VTSE64             = 32'b0111001??????????111000000100111;
  localparam logic [31:0] VTMV_V_T           = 32'b010000111111?????110?????1010111;
  localparam logic [31:0] VTMV_T_V           = 32'b0101111??????????110000001010111;
  localparam logic [31:0] VTZERO             = 32'b01000011111000000110????01010111;
  localparam logic [31:0] VTDISCARD          = 32'b01000011110000000110000001010111;
  localparam logic [31:0] MLD_LHS            = 32'b0001000??????????????00000001011;
  localparam logic [31:0] MLD_RHS            = 32'b0000010??????????????00000001011;
  localparam logic [31:0] MST                = 32'b0000100??????????????00000001011;
  localparam logic [31:0] MMACC              = 32'b0010100??????????000000000001011;
  localparam logic [31:0] MZERO_A            = 32'b0010000??00000000000000000001011;
  localparam logic [31:0] MZERO_M            = 32'b0010010000000????000000000001011;
  localparam logic [31:0] MMOV_AM            = 32'b0100000??00000000????00000001011;
  localparam logic [31:0] MMOV_AA            = 32'b0100010????000000000000000001011;
  localparam logic [31:0] MMOV_MA            = 32'b010010000??00????000000000001011;
  localparam logic [31:0] MMOV_MM            = 32'b0100110000000????????00000001011;
  localparam logic [31:0] MCFGK              = 32'b011000000000?????000?????0001011;
  localparam logic [31:0] MCFGM              = 32'b011001000000???????0?????0001011;
  localparam logic [31:0] MCFGN              = 32'b011010000000???????0?????0001011;
  localparam logic [31:0] MMAC_DT            = 32'b0110110???????????????0000001011;
  /* CSR Addresses */

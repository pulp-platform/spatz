...
package riscv_instr;
  ...
  localparam logic [31:0] VLXBLK4EI8_V       = 32'b0001000??????????000?????0101011;
  localparam logic [31:0] VLXBLK4EI16_V      = 32'b0001000??????????101?????0101011;
  localparam logic [31:0] VLXBLK6EI8_V       = 32'b0001001??????????000?????0101011;
  localparam logic [31:0] VLXBLK6EI16_V      = 32'b0001001??????????101?????0101011;
  localparam logic [31:0] VLXBLK8EI8_V       = 32'b0001010??????????000?????0101011;
  localparam logic [31:0] VLXBLK8EI16_V      = 32'b0001010??????????101?????0101011;
  localparam logic [31:0] VLXBLK12EI8_V      = 32'b0001011??????????000?????0101011;
  localparam logic [31:0] VLXBLK12EI16_V     = 32'b0001011??????????101?????0101011;
  localparam logic [31:0] VLXBLK16EI8_V      = 32'b0001100??????????000?????0101011;
  localparam logic [31:0] VLXBLK16EI16_V     = 32'b0001100??????????101?????0101011;
  localparam logic [31:0] VLXBLK32EI8_V      = 32'b0001101??????????000?????0101011;
  /* CSR Addresses */

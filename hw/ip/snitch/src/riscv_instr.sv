...
package riscv_instr;
  ...
  localparam [31:0] FLB_SPATZ          = 32'b?????????????????100?????0000111;
  ...
  localparam [31:0] FSB_SPATZ          = 32'b?????????????????100?????0100111;
  ...
  localparam [31:0] P_FLB_RRPOST       = 32'b1010000??????????000?????1111011;
  localparam [31:0] P_FLD_RRPOST       = 32'b1010000??????????011?????1111011;
  localparam [31:0] P_FLH_RRPOST       = 32'b1010000??????????001?????1111011;
  localparam [31:0] P_FLW_RRPOST       = 32'b1010000??????????010?????1111011;
  localparam [31:0] P_VLE16_V_RRPOST   = 32'b110000???????????101?????1111011;
  localparam [31:0] P_VLE32_V_RRPOST   = 32'b110000???????????110?????1111011;
  localparam [31:0] P_VLE64_V_RRPOST   = 32'b110000???????????111?????1111011;
  localparam [31:0] P_VLE8_V_RRPOST    = 32'b110000???????????000?????1111011;
  localparam [31:0] P_VLX16_V_RRPOST   = 32'b110001???????????101?????1111011;
  localparam [31:0] P_VLX32_V_RRPOST   = 32'b110001???????????110?????1111011;
  localparam [31:0] P_VLX64_V_RRPOST   = 32'b110001???????????111?????1111011;
  localparam [31:0] P_VLX8_V_RRPOST    = 32'b110001???????????000?????1111011;
  ...
  localparam [31:0] VFCOS_V            = 32'b010011??????01100001?????1010111;
  localparam [31:0] VFCOSHF_V          = 32'b010011??????11001001?????1010111;
  localparam [31:0] VFCOSHS_V          = 32'b010011??????11000001?????1010111;
  ...
  localparam [31:0] VFEXPF_V           = 32'b010011??????01001001?????1010111;
  localparam [31:0] VFEXPS_V           = 32'b010011??????01000001?????1010111;
  ...
  localparam [31:0] VFLOG_V            = 32'b010011??????10101001?????1010111;
  ...
  localparam [31:0] VFSIN_V            = 32'b010011??????01101001?????1010111;
  ...
  localparam [31:0] VFTANHF_V          = 32'b010011??????11101001?????1010111;
  localparam [31:0] VFTANHS_V          = 32'b010011??????11100001?????1010111;
  ...
  localparam [31:0] VFWDOTP_VF         = 32'b111011???????????101?????1010111;
  localparam [31:0] VFWDOTP_VV         = 32'b111011???????????001?????1010111;
  ...
  localparam [31:0] VFXMACC_VF         = 32'b100101???????????101?????1010111;
  localparam [31:0] VFXMACC_VRF        = 32'b?????00??????????010?????0001011;
  localparam [31:0] VFXMUL_VF          = 32'b100110???????????101?????1010111;
  localparam [31:0] VFXMUL_VRF         = 32'b?????01??????????010?????0001011;
  ...
  localparam [31:0] VLX16_V            = 32'b???100?00000?????101?????0000111;
  localparam [31:0] VLX32_V            = 32'b???100?00000?????110?????0000111;
  localparam [31:0] VLX64_V            = 32'b???100?00000?????111?????0000111;
  localparam [31:0] VLX8_V             = 32'b???100?00000?????000?????0000111;
  ...
  localparam [31:0] VMXDOTP_QF         = 32'b?????????????????????????0011111;
  localparam [31:0] VMXDOTP_QQ         = 32'b?????????????????????????0111111;
  localparam [31:0] VMXDOTP_WF         = 32'b?????????????????????????1011111;
  localparam [31:0] VMXDOTP_WW         = 32'b?????????????????????????1111111;
  ...
  localparam [31:0] VVENTCLR           = 32'b00000110000000000010000000001011;

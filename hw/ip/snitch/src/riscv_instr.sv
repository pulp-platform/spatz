...
package riscv_instr;
  ...
  localparam logic [31:0] VMXDOTP_WF         = 32'b?????????????????????????1011111;
  localparam logic [31:0] VMXDOTP_WW         = 32'b?????????????????????????1111111;
  localparam logic [31:0] VMXDOTP_QF         = 32'b?????????????????????????0011111;
  localparam logic [31:0] VMXDOTP_QQ         = 32'b?????????????????????????0111111;
  /* CSR Addresses */

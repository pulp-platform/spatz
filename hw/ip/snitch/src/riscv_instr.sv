...
package riscv_instr;
  ...
  localparam logic [31:0] MSETMTYPEI         = 32'b1000010??011?????111000001010111;
  localparam logic [31:0] VTFMM_TVV          = 32'b1111001??????????001???001110111;
  localparam logic [31:0] VTFMM_ALT_TVV      = 32'b1111001??????????001???011110111;
  localparam logic [31:0] VTMMU_TVV          = 32'b1111001??????????000???001110111;
  localparam logic [31:0] VTMMS_TVV          = 32'b1111001??????????000???011110111;
  localparam logic [31:0] VTLE8              = 32'b0001001??????????011000000000111;
  localparam logic [31:0] VTLE16             = 32'b0011001??????????011000000000111;
  localparam logic [31:0] VTLE32             = 32'b0101001??????????011000000000111;
  localparam logic [31:0] VTLE64             = 32'b0111001??????????011000000000111;
  localparam logic [31:0] VTSE8              = 32'b0001001??????????011000000100111;
  localparam logic [31:0] VTSE16             = 32'b0011001??????????011000000100111;
  localparam logic [31:0] VTSE32             = 32'b0101001??????????011000000100111;
  localparam logic [31:0] VTSE64             = 32'b0111001??????????011000000100111;
  localparam logic [31:0] VTMV_V_T           = 32'b010000111111?????110?????1010111;
  localparam logic [31:0] VTMV_T_V           = 32'b0101111??????????110000001010111;
  localparam logic [31:0] VTZERO             = 32'b01000011111000000110?????1010111;

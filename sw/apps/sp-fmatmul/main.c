...
void print_matrix(float const *matrix, unsigned int num_rows,
...
int main() {
  ...
  if (cid == 0) {
    a = (float *)domain_malloc(get_alloc_tile(0),
                                gemm_l.M * gemm_l.K * sizeof(float));
    b = (float *)domain_malloc(get_alloc_tile(0),
                                gemm_l.K * gemm_l.N * sizeof(float));
    c = (float *)domain_malloc(get_alloc_tile(0),
                                gemm_l.M * gemm_l.N * sizeof(float));
  }

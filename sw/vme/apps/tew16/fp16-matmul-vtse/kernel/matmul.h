...
//
// The optimized kernel evaluates B0 and B1 concurrently with all eight logical
// tiles. It is specialized for M=N=64 and K=64 or K=128; C has a fixed
// CHUNK_SIZE-element row stride.

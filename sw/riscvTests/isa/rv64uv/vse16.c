...
void TEST_CASE1(void) {
  ...
  asm volatile("vse16.v v0, (%0)" ::"r"(ALIGNED_I16) : "memory");
...
void TEST_CASE2(void) {
  ...
  VLOAD_16(v3, 0x05e0, 0xbbd3, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x3489, 0x9388,
           0x8188, 0x11ae, 0x5808, 0x4891, 0x4902, 0x8759, 0x1111, 0x1989);
  asm volatile("vse16.v v3, (%0), v0.t" ::"r"(ALIGNED_I16) : "memory");
  VCLEAR(v3);
...
void TEST_CASE3(void) {
  ...
  asm volatile("vse16.v v3, (%0)" ::"r"(ALIGNED_I16) : "memory");
  VCLEAR(v3);
  VLOAD_16(v3, 0x05e0, 0xbbd3, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x3489, 0x9388,
           0x8188, 0x11ae, 0x5808, 0x4891, 0x4902, 0x8759, 0x1111, 0x1989);
  asm volatile("vse16.v v3, (%0), v0.t" ::"r"(ALIGNED_I16) : "memory");
...
void TEST_CASE5(void) {
  ...
  VLOAD_16(v8, 0x05e0, 0xbbd3, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x3489, 0x9388,
           0x8188, 0x11ae, 0x5808, 0x4891, 0x4902, 0x8759, 0x1111, 0x1989);
  VSET(16, e8, m4);
  asm volatile("vse16.v v8, (%0)" ::"r"(ALIGNED_I16) : "memory");
  VCLEAR(v8);
...
void TEST_CASE6(void) {
  ...
  VLOAD_16(v6, 0x05e0, 0xbbd3, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x3489, 0x9388,
           0x8188, 0x11ae, 0x5808, 0x4891, 0x4902, 0x8759, 0x1111, 0x1989);
  asm volatile("vse16.v v6, (%0)" ::"r"(ALIGNED_I16) : "memory");
  VCLEAR(v6);
...
void TEST_CASE7(void) {
  ...
  asm volatile("vse16.v v8, (%0), v0.t" ::"r"(ALIGNED_I16) : "memory");

...
void TEST_CASE1(void) {
  ...
  VSET(2, e8, m1);
  VLOAD_8(v2, 1, 15);
  asm volatile("vloxei8.v v1, (%0), v2" ::"r"(&ALIGNED_I8[0]) : "memory");
  ...
  VSET(2, e16, m1);
  VLOAD_16(v2, 2, 30);
  asm volatile("vloxei16.v v1, (%0), v2" ::"r"(&ALIGNED_I16[0]) : "memory");
  ...
  VSET(2, e32, m1);
  VLOAD_32(v2, 4, 60);
  asm volatile("vloxei32.v v1, (%0), v2" ::"r"(&ALIGNED_I32[0]) : "memory");
...
void TEST_CASE2(void) {
  ...
  VSET(2, e16, m1);
  VLOAD_8(v2, 2, 30);
  asm volatile("vloxei8.v v1, (%0), v2" ::"r"(&ALIGNED_I16[0]) : "memory");
  ...
  VSET(2, e32, m1);
  VLOAD_16(v2, 4, 60);
  asm volatile("vloxei16.v v1, (%0), v2" ::"r"(&ALIGNED_I32[0]) : "memory");
  ...
  VSET(2, e64, m1);
  VLOAD_32(v2, 8, 120);
  asm volatile("vloxei32.v v1, (%0), v2" ::"r"(&ALIGNED_I64[0]) : "memory");
...
void TEST_CASE3(void) {
  ...
  VSET(2, e8, m1);
  VLOAD_16(v2, 1, 15);
  asm volatile("vloxei16.v v1, (%0), v2" ::"r"(&ALIGNED_I8[0]) : "memory");
  ...
  VSET(2, e16, m1);
  VLOAD_32(v2, 2, 30);
  asm volatile("vloxei32.v v1, (%0), v2" ::"r"(&ALIGNED_I16[0]) : "memory");
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v1, 99, 99);
  VLOAD_8(v2, 1, 15);
  asm volatile("vloxei8.v v1, (%0), v2, v0.t" ::"r"(&ALIGNED_I8[0]) : "memory");
  ...
  asm volatile("vloxei16.v v1, (%0), v2, v0.t" ::"r"(&ALIGNED_I16[0]) : "memory");
  ...
  VLOAD_32(v1, 999, 999);
  VLOAD_32(v2, 4, 60);
  asm volatile("vloxei32.v v1, (%0), v2, v0.t" ::"r"(&ALIGNED_I32[0]) : "memory");
...
/*#if ELEN == 64
  ...
  VLOAD_64(v2, 8, 120);
  VLOAD_8(v0, 0xAA);
  asm volatile("vloxei64.v v1, (%0), v2, v0.t" ::"r"(&ALIGNED_I64[0]) : "memory");

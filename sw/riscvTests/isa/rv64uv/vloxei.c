...
void TEST_CASE1(void) {
  { // eew_dest = eew_idx = e8
    ...
    asm volatile("vloxei8.v v4, (%0), v8" ::"r"(&BUF[0]) : "memory");
  ...
  { // eew_dest = eew_idx = e16
    ...
    asm volatile("vloxei16.v v4, (%0), v8" ::"r"(&BUF[0]) : "memory");
  ...
  { // eew_dest = eew_idx = e32
    ...
    asm volatile("vloxei32.v v4, (%0), v8" ::"r"(&BUF[0]) : "memory");
...
void TEST_CASE2(void) {
  { // eew_dest = eew_idx = e8
    ...
    VLOAD_8(v8, 1, 2, 3, 4, 5, 7, 8, 9, 11, 12, 13, 15);
    asm volatile("vloxei8.v v4, (%0), v8, v0.t" ::"r"(&BUF[0]) : "memory");
  ...
  { // eew_dest = eew_idx = e16
    ...
    VLOAD_8(v0, 0xaa, 0x0a);
    VLOAD_16(v8, 2, 4, 6, 8, 10, 14, 16, 18, 22, 24, 26, 30);
    asm volatile("vloxei16.v v4, (%0), v8, v0.t" ::"r"(&BUF[0]) : "memory");
  ...
  { // eew_dest = eew_idx = e32
    ...
    asm volatile("vloxei32.v v4, (%0), v8, v0.t" ::"r"(&BUF[0]) : "memory");

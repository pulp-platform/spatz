...
void TEST_CASE1(void) {
  ...
  VCMP_U8(3, v2, 0x33, 0x33);
    ...
    VLOAD_64(v4, 0xffffffffffffffff, 0x0000000000000000, 0xf0f0f0f0f0f0f0f0,
             ...
             0x0f0f0f0f0f0f0f0f);
    VLOAD_64(v12, 0xfff2ffffffffffff, 0x0100000000000000, 0xf0f0f0f0f0f0f0f0,
             ...
             0x0f0f0f0f0f0f0f0f);
    VCLEAR(v8);
    asm volatile("vmsne.vv v8, v4, v12");
    VSET(2, e8, m1);
...
void TEST_CASE2(void) {
  ...
  VCMP_U8(7, v2, 0x77, 0x77);
    ...
    VLOAD_8(v0, 0xaa, 0xaa);
    VCLEAR(v8);
    asm volatile("vmsne.vv v8, v4, v12, v0.t");
    VSET(2, e8, m1);
    VCMP_U8(8, v8, 0x77, 0x77);
  #endif
};
...
void TEST_CASE5(void) {
  ...
  VCMP_U8(19, v2, 0xee, 0xee);
    ...
    VLOAD_64(v4, 0x000000000000000f, 0x0000000000000000, 0xf0f0f0f0f0f0f0f0,
             ...
             0x0f0f0f0f0f0f0f0f);
    VCLEAR(v8);
    asm volatile("vmsne.vi v8, v4, 15");
    VSET(2, e8, m1);
...
void TEST_CASE6(void) {
  ...
  VCMP_U8(23, v2, 0xEF, 0xEF);
    ...
    VLOAD_8(v0, 0x10, 0x10);
    VCLEAR(v8);
    asm volatile("vmsne.vi v8, v4, 15, v0.t");
    VSET(2, e8, m1);
    VCMP_U8(24, v8, 0xEF, 0xEF);
  #endif
};

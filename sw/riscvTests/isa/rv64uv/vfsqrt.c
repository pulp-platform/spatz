...
//   __asm__ volatile("vfsqrt.v v2,v4");
//   VEC_CMP_F32(1, v2, _f(3).i, _f(1.73205078).i, _f(1.7724539).i,
//               _f(36.5696602).i);
// }
...
void TEST_CASE1(void) {
  ...
  //              -3674.000,   368.250,   1712.000, -8584.000, -2080.000,
  //              4336.000
  VLOAD_16(v2, 0xf0d9, 0xf0d9, 0xf0d9, 0xf0d9, 0xd867, 0x6df8, 0x6913, 0x6a45,
           0x6020, 0xea71, 0xeb2d, 0x5dc1, 0x66b0, 0xf031, 0xe810, 0x6c3c);
  asm volatile("vfsqrt.v v3, v2");
  //                nan,   71.500,   nan,   96.938,
  //                nan,   78.188,   50.969,   56.656,   22.984,   nan,
  //                nan,   19.188,   41.375,   nan,   nan,   65.875
  VCMP_U16(2, v3, 0x7e00, 0x7e00, 0x7e00, 0x7e00, 0x7e00, 0x54e2, 0x525f,
           0x5315, 0x4dbe, 0x7e00, 0x7e00, 0x4ccc, 0x512c, 0x7e00, 0x7e00,
           0x541d);
  ...
  //                133.390,   nan
  VCMP_U32(3, v3, 0x4367b53e, 0x7fc00000, 0x7fc00000, 0x7fc00000, 0x7fc00000,
  ...
  //                -35066.488,   62475.219, -25604.578,   54705.039,
  //                -19827.459,   17792.961, -28415.572
  VLOAD_32(v2, 0xc5b2b971, 0xc5b2b971, 0xc5b2b971, 0xc5b2b971, 0xc5b2b971,
  ...
  //                114.260,   nan,   nan,   249.950,   nan,   233.891,   nan,
  //                133.390,   nan
  VCMP_U32(4, v3, 0x7fc00000, 0x7fc00000, 0x7fc00000, 0x7fc00000, 0x7fc00000,

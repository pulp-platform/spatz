...
void TEST_CASE1(void) {
  ...
  VCMP_U8(3, v2, 0x99, 0x99);
    ...
    VLOAD_64(v4, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345,
             8, 25, 199);
    VCLEAR(v8);
    asm volatile("vmsgtu.vx v8, v4, %[A]" ::[A] "r"(scalar));
    VSET(2, e8, m1);
...
void TEST_CASE2(void) {
  ...
  VCMP_U8(7, v2, 0xBB, 0xBB);
    ...
    VLOAD_8(v0, 0xCC, 0xCC);
    VCLEAR(v8);
    asm volatile("vmsgtu.vx v8, v4, %[A], v0.t" ::[A] "r"(scalar));
    VSET(2, e8, m1);
...
void TEST_CASE3(void) {
  ...
  VCMP_U8(11, v2, 0xDD, 0xDD);
    ...
    VLOAD_64(v4, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345, 8, 25, 199, 12345,
             8, 25, 199);
    VCLEAR(v8);
    asm volatile("vmsgtu.vi v8, v4, 15");
    VSET(2, e8, m1);
...
void TEST_CASE4(void) {
  ...
  VCMP_U8(15, v2, 0xFF, 0xFF);
    ...
    VLOAD_8(v0, 0xCC, 0xCC);
    VCLEAR(v8);
    asm volatile("vmsgtu.vi v8, v4, 15, v0.t");
    VSET(2, e8, m1);

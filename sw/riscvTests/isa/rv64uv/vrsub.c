...
void TEST_CASE4(void) {
  ...
  void MERGE_TEST_CASE1(void) {
    ...
    VLOAD_8(v2, 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40,
                ...
                5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40);
    asm volatile("vrsub.vi v6, v2, 10");
    VCMP_U8(17, v6, 5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30,
    ...
    VLOAD_16(v2, 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40,
                 ...
                 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40);
    asm volatile("vrsub.vi v6, v2, 10");
    VCMP_U16(18, v6, 5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30,
                     5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30,
                     5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30,
                     5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30,
                     5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30,
    ...
    VLOAD_32(v2, 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40,
                 ...
                 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40);
    asm volatile("vrsub.vi v6, v2, 10");
    VCMP_U32(19, v6, 5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30,
                     5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30,
                     5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30,
                     5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30);
    ...
    VLOAD_64(v2, 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40,
                 5, 10, 15, 20, 25, 30, 35, 40, 5, 10, 15, 20, 25, 30, 35, 40);
    asm volatile("vrsub.vi v6, v2, 10");
    VCMP_U64(20, v6, 5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30,
                     5, 0, -5, -10, -15, -20, -25, -30, 5, 0, -5, -10, -15, -20, -25, -30);
  #endif
}
#endif MERGE_MODE

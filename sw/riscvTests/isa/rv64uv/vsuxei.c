...
void TEST_CASE1(void) {
  ...
  asm volatile("vsuxei8.v v1, (%0), v2" ::"r"(&BUFFER_O8[0]) : "memory");
  ...
  asm volatile("vsuxei16.v v1, (%0), v2" ::"r"(&BUFFER_O16[0]) : "memory");
  ...
  asm volatile("vsuxei32.v v1, (%0), v2" ::"r"(&BUFFER_O32[0]) : "memory");
  ...
  asm volatile("vsuxei32.v v4, (%0), v8" ::"r"(&BUFFER_O32[0]) : "memory");
...
void TEST_CASE2(void) {
  ...
  asm volatile("vsuxei8.v v1, (%0), v2, v0.t" ::"r"(&BUFFER_O8[0]) : "memory");
  VVCMP_U8(5, BUFFER_O8, INIT, INIT, 0x40, INIT, 0x84, INIT, INIT, 0x88,
  ...
  VLOAD_16(v1, 0xbbd3, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x9388, 0x8188, 0x11ae,
           0x4891, 0x4902, 0x8759, 0x1989);
  VLOAD_16(v2, 2, 4, 6, 8, 10, 14, 16, 18, 22, 24, 26, 30);
  asm volatile("vsuxei16.v v1, (%0), v2, v0.t" ::"r"(&BUFFER_O16[0]) : "memory");
  ...
  VLOAD_32(v4, 0xf9aa71f0, 0xa11a9384, 0x99991348, 0x9fa831c7, 0x38197598,
           ...
           0x31897598, 0x89139848);
  VLOAD_32(v8, 4, 8, 12, 16, 20, 28, 32, 36, 44, 48, 52, 60);
  asm volatile("vsuxei32.v v4, (%0), v8, v0.t" ::"r"(&BUFFER_O32[0]) : "memory");
...
/*#if ELEN == 64
  ...
  asm volatile("vsuxei64.v v8, (%0), v16, v0.t" ::"r"(&BUFFER_O64[0]) : "memory");
...
void TEST_CASE3(void) {
  ...
  VLOAD_8(v2, 2, 30);
  asm volatile("vsuxei8.v v1, (%0), v2" ::"r"(&BUFFER_O16[0]) : "memory");
  VVCMP_U16(9, BUFFER_O16, INIT, 0xbbd3, INIT, INIT, INIT, INIT, INIT, INIT,
  ...
  VLOAD_16(v2, 4, 60);
  asm volatile("vsuxei16.v v1, (%0), v2" ::"r"(&BUFFER_O32[0]) : "memory");
  VVCMP_U32(10, BUFFER_O32, INIT, 0xf9aa71f0, INIT, INIT, INIT, INIT, INIT, INIT,
  ...
  VLOAD_32(v2, 8, 120);
  asm volatile("vsuxei32.v v1, (%0), v2" ::"r"(&BUFFER_O64[0]) : "memory");
  VVCMP_U64(11, BUFFER_O64, INIT, 0xf9aa71f0c394bbd3, INIT, INIT, INIT, INIT,
...
void TEST_CASE4(void) {
  ...
  VLOAD_16(v2, 1, 15);
  asm volatile("vsuxei16.v v1, (%0), v2" ::"r"(&BUFFER_O8[0]) : "memory");
  VVCMP_U8(12, BUFFER_O8, INIT, 0xd3, INIT, INIT, INIT, INIT, INIT, INIT,
  ...
  VLOAD_16(v1, 0xbbd3, 0x1989);
  VLOAD_32(v2, 2, 30);
  asm volatile("vsuxei32.v v1, (%0), v2" ::"r"(&BUFFER_O16[0]) : "memory");
  VVCMP_U16(13, BUFFER_O16, INIT, 0xbbd3, INIT, INIT, INIT, INIT, INIT, INIT,
            INIT, INIT, INIT, INIT, INIT, INIT, INIT, 0x1989);
}

...
void TEST_CASE1(void) {
  ...
  VCMP_U8(2, v2, 0xAA, 0xAA);
    ...
    VLOAD_64(v12, 50, 7000, 400, 19901, 50, 7000, 400, 19901, 50, 7000, 400, 19901,
             50, 7000, 400, 19901);
    VCLEAR(v8);
    asm volatile("vmslt.vv v8, v4, v12");
    VSET(2, e8, m1);
...
void TEST_CASE2(void) {
  ...
  VCMP_U8(5, v2, 0xBB, 0xBB);
    ...
    VLOAD_8(v0, 0xCC, 0xCC);
    VCLEAR(v8);
    asm volatile("vmslt.vv v8, v4, v12, v0.t");
    VSET(2, e8, m1);
...
void TEST_CASE3(void) {
  ...
  VCMP_U8(9, v2, 0x66, 0x66);
    ...
    VLOAD_64(v4, 12345, -8, -25, 199, 12345, -8, -25, 199, 12345, -8, -25, 199,
             12345, -8, -25, 199);
    VCLEAR(v8);
    asm volatile("vmslt.vx v8, v4, %[A]" ::[A] "r"(scalar));
    VSET(2, e8, m1);
...
void TEST_CASE4(void) {
  ...
  VCMP_U8(13, v2, 0x77, 0x77);
    ...
    VLOAD_8(v0, 0xCC, 0xCC);
    VCLEAR(v8);
    asm volatile("vmslt.vx v8, v4, %[A], v0.t" ::[A] "r"(scalar));
    VSET(2, e8, m1);

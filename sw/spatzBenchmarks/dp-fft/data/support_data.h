...
#ifndef _FFT_SUPPORT_H_
#define _FFT_SUPPORT_H_

#if FFT_SAMPLES == 4

uint8_t mask_addr_0[1] __attribute__((section(".data"))) = {0xAA};
const uint8_t *mask_addr_vec[2] = {mask_addr_0};
uint32_t index_ptr[4] __attribute__((section(".data"))) = {0, 1};

#elif FFT_SAMPLES == 8

uint8_t mask_addr_0[1] __attribute__((section(".data"))) = {0xCC};
uint8_t mask_addr_1[1] __attribute__((section(".data"))) = {0xAA};
const uint8_t *mask_addr_vec[2] = {mask_addr_0, mask_addr_1};
uint32_t index_ptr[4] __attribute__((section(".data"))) = {0, 2, 1, 3};

#elif FFT_SAMPLES == 16

uint8_t mask_addr_0[2] __attribute__((section(".data"))) = {0xF0, 0xF0};
uint8_t mask_addr_1[2] __attribute__((section(".data"))) = {0xCC, 0xCC};
uint8_t mask_addr_2[2] __attribute__((section(".data"))) = {0xAA, 0xAA};
const uint8_t *mask_addr_vec[3] = {mask_addr_0, mask_addr_1, mask_addr_2};
uint32_t index_ptr[8]
    __attribute__((section(".data"))) = {0, 4, 2, 6, 1, 5, 3, 7};

#elif FFT_SAMPLES == 32

uint8_t mask_addr_0[4]
    __attribute__((section(".data"))) = {0x00, 0xFF, 0x00, 0xFF};
uint8_t mask_addr_1[4]
    __attribute__((section(".data"))) = {0xF0, 0xF0, 0xF0, 0xF0};
uint8_t mask_addr_2[4]
    __attribute__((section(".data"))) = {0xCC, 0xCC, 0xCC, 0xCC};
uint8_t mask_addr_3[4]
    __attribute__((section(".data"))) = {0xAA, 0xAA, 0xAA, 0xAA};
const uint8_t *mask_addr_vec[4] = {mask_addr_0, mask_addr_1, mask_addr_2,
                                   mask_addr_3};
uint32_t index_ptr[16] __attribute__((section(".data"))) = {
    0, 8, 4, 12, 2, 10, 6, 14, 1, 9, 5, 13, 3, 11, 7, 15};

#elif FFT_SAMPLES == 64

uint8_t mask_addr_0[8] __attribute__((section(".data"))) = {
    0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF};
uint8_t mask_addr_1[8] __attribute__((section(".data"))) = {
    0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF};
uint8_t mask_addr_2[8] __attribute__((section(".data"))) = {
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0};
uint8_t mask_addr_3[8] __attribute__((section(".data"))) = {
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC};
uint8_t mask_addr_4[8] __attribute__((section(".data"))) = {
    0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA};
const uint8_t *mask_addr_vec[5] = {mask_addr_0, mask_addr_1, mask_addr_2,
                                   mask_addr_3, mask_addr_4};
uint32_t index_ptr[32] __attribute__((section(".data"))) = {
    0, 16, 8, 24, 4, 20, 12, 28, 2, 18, 10, 26, 6, 22, 14, 30,
    1, 17, 9, 25, 5, 21, 13, 29, 3, 19, 11, 27, 7, 23, 15, 31};

#elif FFT_SAMPLES == 128

uint8_t mask_addr_0[16] __attribute__((section(".data"))) = {
    0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
    0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF};
uint8_t mask_addr_1[16] __attribute__((section(".data"))) = {
    0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF,
    0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF};
uint8_t mask_addr_2[16] __attribute__((section(".data"))) = {
    0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF,
    0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF};
uint8_t mask_addr_3[16] __attribute__((section(".data"))) = {
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0,
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0};
uint8_t mask_addr_4[16] __attribute__((section(".data"))) = {
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC};
uint8_t mask_addr_5[16] __attribute__((section(".data"))) = {
    0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
    0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA};
const uint8_t *mask_addr_vec[6] = {mask_addr_0, mask_addr_1, mask_addr_2,
                                   mask_addr_3, mask_addr_4, mask_addr_5};
uint32_t index_ptr[64] __attribute__((section(".data"))) = {
...
uint8_t mask_addr_0[32] __attribute__((section(".data"))) = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
uint8_t mask_addr_1[32] __attribute__((section(".data"))) = {
...
uint8_t mask_addr_2[32] __attribute__((section(".data"))) = {
...
uint8_t mask_addr_3[32] __attribute__((section(".data"))) = {
...
uint8_t mask_addr_4[32] __attribute__((section(".data"))) = {
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0,
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0,
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0};
uint8_t mask_addr_5[32] __attribute__((section(".data"))) = {
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC};
uint8_t mask_addr_6[32] __attribute__((section(".data"))) = {
...
const uint8_t *mask_addr_vec[7] = {mask_addr_0, mask_addr_1, mask_addr_2,
                                   mask_addr_3, mask_addr_4, mask_addr_5,
                                   mask_addr_6};
uint32_t index_ptr[128] __attribute__((section(".data"))) = {
...
uint8_t mask_addr_0[64] __attribute__((section(".data"))) = {
...
uint8_t mask_addr_1[64] __attribute__((section(".data"))) = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
uint8_t mask_addr_2[64] __attribute__((section(".data"))) = {
    0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00,
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF,
...
uint8_t mask_addr_3[64] __attribute__((section(".data"))) = {
    0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF,
    0xFF, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00,
...
uint8_t mask_addr_4[64] __attribute__((section(".data"))) = {
    0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00,
    0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF,
    0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00,
    0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF,
...
uint8_t mask_addr_5[64] __attribute__((section(".data"))) = {
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0,
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0,
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0,
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0,
...
uint8_t mask_addr_6[64] __attribute__((section(".data"))) = {
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
...
uint8_t mask_addr_7[64] __attribute__((section(".data"))) = {
    0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
    0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
    0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
    0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
...
uint8_t mask_addr_0[128] __attribute__((section(".data"))) = {
...
uint8_t mask_addr_1[128] __attribute__((section(".data"))) = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
uint8_t mask_addr_2[128] __attribute__((section(".data"))) = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    ...
    0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
uint8_t mask_addr_3[128] __attribute__((section(".data"))) = {
    ...
    0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
    0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF};
uint8_t mask_addr_4[128] __attribute__((section(".data"))) = {
    ...
    0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF,
    0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF};
uint8_t mask_addr_5[128] __attribute__((section(".data"))) = {
    ...
    0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF,
    0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF};
uint8_t mask_addr_6[128] __attribute__((section(".data"))) = {
    ...
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0,
    0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0};
uint8_t mask_addr_7[128] __attribute__((section(".data"))) = {
    ...
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC};
uint8_t mask_addr_8[128] __attribute__((section(".data"))) = {

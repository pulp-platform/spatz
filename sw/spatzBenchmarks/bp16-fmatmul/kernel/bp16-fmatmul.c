...
void matmul_16xVL(__fp16 *c, const __fp16 *a, const __fp16 *b,
  ...
  while (p < p_end) {
    ...
    for (unsigned int m = m_start; m < m_end; m += 16) {
      ...
      asm volatile("flh %[t], 0(%[a])" : [t] "=f"(t7) : [a] "r"(a__));
      a__ += N;
      asm volatile("flh %[t], 0(%[a])" : [t] "=f"(t8) : [a] "r"(a__));
      a__ += N;
      asm volatile("flh %[t], 0(%[a])" : [t] "=f"(t9) : [a] "r"(a__));
      a__ += N;
      asm volatile("flh %[t], 0(%[a])" : [t] "=f"(t10) : [a] "r"(a__));
      a__ += N;
      asm volatile("flh %[t], 0(%[a])" : [t] "=f"(t11) : [a] "r"(a__));
      a__ += N;
      asm volatile("flh %[t], 0(%[a])" : [t] "=f"(t12) : [a] "r"(a__));
      a__ += N;
      asm volatile("flh %[t], 0(%[a])" : [t] "=f"(t13) : [a] "r"(a__));
      a__ += N;
      asm volatile("flh %[t], 0(%[a])" : [t] "=f"(t14) : [a] "r"(a__));
      a__ += N;
      asm volatile("flh %[t], 0(%[a])" : [t] "=f"(t15) : [a] "r"(a__));
      ...
      while (n < N) {
        ...
        asm volatile("vle16.v v17, (%0);" ::"r"(b__));
        b__ += P;
      ...
      c__ += P;
      asm volatile("vfmacc.vf v1, %0, v17" ::"f"(t1));
      asm volatile("vse16.v v1, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v2, %0, v17" ::"f"(t2));
      asm volatile("vse16.v v2, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v3, %0, v17" ::"f"(t3));
      asm volatile("vse16.v v3, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v4, %0, v17" ::"f"(t4));
      asm volatile("vse16.v v4, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v5, %0, v17" ::"f"(t5));
      asm volatile("vse16.v v5, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v6, %0, v17" ::"f"(t6));
      asm volatile("vse16.v v6, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v7, %0, v17" ::"f"(t7));
      asm volatile("vse16.v v7, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v8, %0, v17" ::"f"(t8));
      asm volatile("vse16.v v8, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v9, %0, v17" ::"f"(t9));
      asm volatile("vse16.v v9, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v10, %0, v17" ::"f"(t10));
      asm volatile("vse16.v v10, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v11, %0, v17" ::"f"(t11));
      asm volatile("vse16.v v11, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v12, %0, v17" ::"f"(t12));
      asm volatile("vse16.v v12, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v13, %0, v17" ::"f"(t13));
      asm volatile("vse16.v v13, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v14, %0, v17" ::"f"(t14));
      asm volatile("vse16.v v14, (%0);" ::"r"(c__));
      c__ += P;
      asm volatile("vfmacc.vf v15, %0, v17" ::"f"(t15));
      asm volatile("vse16.v v15, (%0);" ::"r"(c__));
    }
    p += gvl;
  }
}

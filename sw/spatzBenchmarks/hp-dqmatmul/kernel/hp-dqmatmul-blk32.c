...
#include "hp-dqmatmul-blk32.h"
#include <stddef.h>
#include <stdint.h>

#define CB_D   32u // 8 elements per codebook entry

// ---------------
// 4xVL
// ---------------

void dq_matmul_4xVL_blk32(__fp16 *c, const __fp16 *a, const __fp16 *b_cb0, const __fp16 *b_cb1,
  ...
  while (p < p_end) {
    ...
    for (unsigned int m = m_start; m < m_end; m += 4) {
      ...
      asm volatile("vlxblk32ei8.v v16,  (%0), v28" :: "r"(cb0_reg) : "memory");
      asm volatile("vlxblk32ei8.v v24, (%0), v30" :: "r"(cb1_reg) : "memory");
      ...
      asm volatile("vsetvli zero, %0, e16, m4, ta, ma" :: "r"(gvl));
      asm volatile("vlxblk32ei8.v v20, (%0), v28" :: "r"(cb0_reg) : "memory");
      asm volatile("vlxblk32ei8.v v24, (%0), v30" :: "r"(cb1_reg) : "memory");
...
void dq_matmul_4xVL_dp_blk32(__fp16 *c, const __fp16 *a, const __fp16 *b_cb0, const __fp16 *b_cb1,
                    const uint8_t *b_idx0, const uint8_t *b_idx1,
                    const unsigned int m_start, const unsigned int m_end,
                    const unsigned int N, const unsigned int P,
                    const unsigned int p_start, const unsigned int p_end) {

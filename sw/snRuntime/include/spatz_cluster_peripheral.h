...
#define SPATZ_CLUSTER_PERIPHERAL_CFG_L1D_SPM_SPM_SIZE_FIELD                    \
  ((bitfield_field32_t){                                                       \
      .mask = SPATZ_CLUSTER_PERIPHERAL_CFG_L1D_SPM_SPM_SIZE_MASK,              \
...
#define SPATZ_CLUSTER_PERIPHERAL_CFG_L1D_INSN_INSN_FIELD                       \
  ((bitfield_field32_t){                                                       \
      .mask = SPATZ_CLUSTER_PERIPHERAL_CFG_L1D_INSN_INSN_MASK,                 \
...
#define SPATZ_CLUSTER_PERIPHERAL_XBAR_OFFSET_REG_OFFSET 0x98
#define SPATZ_CLUSTER_PERIPHERAL_XBAR_OFFSET_OFFSET_MASK 0x1f
#define SPATZ_CLUSTER_PERIPHERAL_XBAR_OFFSET_OFFSET_OFFSET 0
#define SPATZ_CLUSTER_PERIPHERAL_XBAR_OFFSET_OFFSET_FIELD                      \
  ((bitfield_field32_t){                                                       \
      .mask = SPATZ_CLUSTER_PERIPHERAL_XBAR_OFFSET_OFFSET_MASK,                \
      .index = SPATZ_CLUSTER_PERIPHERAL_XBAR_OFFSET_OFFSET_OFFSET})

// Cache xbar offset setting
#define SPATZ_CLUSTER_PERIPHERAL_XBAR_OFFSET_COMMIT_REG_OFFSET 0xa0
#define SPATZ_CLUSTER_PERIPHERAL_XBAR_OFFSET_COMMIT_COMMIT_BIT 0

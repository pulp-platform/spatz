/*  rsqrt_hw.c – Hardware inverse-sqrt via vfrsqrt7.v burst pattern
 *
 *  Algorithm:  4-way unrolled load → vfrsqrt7.v → store
 *  The HW instruction provides 7-bit accurate 1/√x seed.
 *
...
/* ========================= LMUL = 8 ========================= */
static inline void vrsqrt_hw_m8(const float *inp, float *out, int N) {
    size_t vl;
...
/* ========================= LMUL = 4 ========================= */
static inline void vrsqrt_hw_m4(const float *inp, float *out, int N) {
    size_t vl;
...
/* ========================= LMUL = 2 ========================= */
static inline void vrsqrt_hw_m2(const float *inp, float *out, int N) {
    size_t vl;
...
/* ========================= LMUL = 1 ========================= */
static inline void vrsqrt_hw_m1(const float *inp, float *out, int N) {
    size_t vl;
...
static inline void vrsqrt_hw_kernel(const float *inp, float *out, int N) {
#if   LMUL_MODE == 8

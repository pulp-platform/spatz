/*  exp_hw.c – Hardware exponential via vfexpf.v burst pattern
 *
 ...
 */
static inline void vexp_hw_m8(const float *inp, float *out, int N) {
    size_t vl;
...
/* ========================= LMUL = 4 ========================= */
static inline void vexp_hw_m4(const float *inp, float *out, int N) {
    size_t vl;
...
/* ========================= LMUL = 2 ========================= */
static inline void vexp_hw_m2(const float *inp, float *out, int N) {
    size_t vl;
...
/* ========================= LMUL = 1 ========================= */
static inline void vexp_hw_m1(const float *inp, float *out, int N) {
    size_t vl;
...
static inline void vexp_hw_kernel(const float *inp, float *out, int N) {
#if   LMUL_MODE == 8

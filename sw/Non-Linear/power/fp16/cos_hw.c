/*  cos_hw.c - Hardware cosine via vfcos.v burst pattern (FP16)
...
static inline void vcos_hw_m8(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vcos_hw_m4(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vcos_hw_m2(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vcos_hw_m1(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vcos_hw_kernel(const uint16_t *inp, uint16_t *out, int N) {
#if   LMUL_MODE == 8
...
int main(void) {
    ...
    if (cid == 0) {
        ...
        stop_kernel();
        printf("[COS_HW_FP16 LMUL=%d] cycles=%u  cores=%u  N=%d\n",
               LMUL_MODE, cyc, cores, N);
        check_fp16(g_out, outCos, N, "COS_HW_FP16");
    }
    snrt_cluster_hw_barrier();
    return 0;
}

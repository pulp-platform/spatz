/*  Mish baseline – Mish activation using SW exp, ln, tanh (BF16)
 *
...
/* ---- Fast ln constants ---- */
#define H_LN_BIAS 0x3F80u
#define H_LN_SCALE 0x3BB1u
...
int main(void) {
    ...
    if (cid == 0) {
        ...
        stop_kernel();
        printf("[MISH BASELINE BF16] cycles=%u  cores=%u  N=%d\n", cyc, cores, N);

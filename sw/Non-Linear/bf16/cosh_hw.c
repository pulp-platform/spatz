/*  cosh_hw.c - Hardware cosh via vfcoshf.v burst pattern (BF16)
...
static inline void vcosh_hw_m8(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vcosh_hw_m4(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vcosh_hw_m2(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vcosh_hw_m1(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vcosh_hw_kernel(const uint16_t *inp, uint16_t *out, int N) {
#if   LMUL_MODE == 8
...
int main(void) {
    ...
    if (cid == 0) {
        ...
        check_bf16(g_out, outC, N, "COSH_HW");
    }

/*  log_hw.c - Hardware log via vflog.v burst pattern (BF16)
...
static inline void vlog_hw_m8(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vlog_hw_m4(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vlog_hw_m2(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vlog_hw_m1(const uint16_t *inp, uint16_t *out, int N) {
    size_t vl;
...
static inline void vlog_hw_kernel(const uint16_t *inp, uint16_t *out, int N) {
#if   LMUL_MODE == 8
...
int main(void) {
    ...
    if (cid == 0) {
        ...
        check_bf16(g_out, outL, N, "LOG_HW");
    }

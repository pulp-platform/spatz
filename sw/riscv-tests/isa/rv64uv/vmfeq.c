...
void TEST_CASE3(void) {
  ...
  asm volatile("vmfeq.vf v2, v4, %[A]" ::[A] "f"(fscalar_16));
  VSET(1, e16, m2);
  ...
  VLOAD_64(v4, 0x3fec543182780b14, 0xbfc33a041b62e250, 0xbfe8f9623feb8e20,
           ...
           0xbfe01c2a245f7960);
  asm volatile("vmfeq.vf v2, v4, %[A]" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(9, v2, 0x0008);
};
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfeq.vf v2, v4, %[A], v0.t" ::[A] "f"(fscalar_16));
  VSET(1, e16, m2);
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v2);
  asm volatile("vmfeq.vf v2, v4, %[A], v0.t" ::[A] "f"(dscalar_64));
  VSET(1, e16, m2);
  VCMP_U16(12, v2, 0x0008);
};
...
void TEST_CASE5(void) {
  ...
  asm volatile("vmfeq.vv v2, v4, v6");
  VSET(1, e64, m2);
  VCMP_U64(13, v2, 0xffffffffffff0001);
  ...
  asm volatile("vmfeq.vv v2, v4, v6");
  VSET(1, e64, m2);
  VCMP_U64(14, v2, 0xffffffffffff0004);
  ...
  asm volatile("vmfeq.vv v2, v4, v6");
  VSET(1, e64, m2);
  VCMP_U64(15, v2, 0xffffffffffff0001);
};

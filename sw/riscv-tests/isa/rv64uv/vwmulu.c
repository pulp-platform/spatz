...
void TEST_CASE1(void) {
  VSET(16, e8, m8);
  VLOAD_8(v8, 0x74, 0xfb, 0xf4, 0xe9, 0xe5, 0x4e, 0x02, 0x27, 0xe9, 0x83, 0xfe,
          0x03, 0xb2, 0xb9, 0x9a, 0x71);
  VLOAD_8(v16, 0x67, 0xa9, 0x07, 0x0f, 0xe3, 0x0d, 0xce, 0x81, 0xa2, 0xa5, 0x59,
          0x18, 0x0d, 0xac, 0x80, 0x31);
  asm volatile("vwmulu.vv v24, v8, v16");
  VSET(16, e16, m8);
  VCMP_U16(1, v24, 0x2eac, 0xa5b3, 0x06ac, 0x0da7, 0xcb0f, 0x03f6, 0x019c,
           0x13a7, 0x9372, 0x546f, 0x584e, 0x0048, 0x090a, 0x7c4c, 0x4d00,
           0x15a1);

  VSET(16, e16, m8);
  VLOAD_16(v8, 0xcf44, 0x249f, 0x3b1d, 0xea59, 0x0c47, 0xd24b, 0xce3e, 0xdb61,
           0x3506, 0xcee2, 0x3c7e, 0xc169, 0x05fd, 0x7fe6, 0xf7db, 0xb7cd);
  VLOAD_16(v16, 0xaa0b, 0x2176, 0x34bc, 0x4aa6, 0x221e, 0x9f98, 0x63f5, 0x8da7,
           0x001d, 0x18d7, 0x1dbb, 0x5f2d, 0x0783, 0xd756, 0xa08d, 0x9c49);
  asm volatile("vwmulu.vv v24, v8, v16");
  VSET(16, e32, m8);
  VCMP_U32(2, v24, 0x89ac0fec, 0x04c9604a, 0x0c2d4d4c, 0x4455afb6, 0x01a2de52,
...
void TEST_CASE2(void) {
  ...
  VSET(16, e16, m8);
  VCMP_U16(4, v24, 0, 0xa5b3, 0, 0x0da7, 0, 0x03f6, 0, 0x13a7, 0, 0x546f, 0,
  ...
  asm volatile("vwmulu.vv v24, v8, v16, v0.t");
  VSET(16, e32, m8);
  VCMP_U32(5, v24, 0, 0x04c9604a, 0, 0x4455afb6, 0, 0x83197188, 0, 0x79638947,
...
void TEST_CASE3(void) {
  VSET(16, e8, m8);
  VLOAD_8(v8, 0xf8, 0x11, 0x12, 0xf1, 0x63, 0x21, 0x88, 0x3b, 0x01, 0xf5, 0x6d,
          0xf5, 0xb1, 0x54, 0xcd, 0xb0);
  uint64_t scalar = 5;
  asm volatile("vwmulu.vx v24, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e16, m8);
  VCMP_U16(7, v24, 0x04d8, 0x0055, 0x005a, 0x04b5, 0x01ef, 0x00a5, 0x02a8,
           0x0127, 0x0005, 0x04c9, 0x0221, 0x04c9, 0x0375, 0x01a4, 0x0401,
           0x0370);

  VSET(16, e16, m8);
  VLOAD_16(v8, 0xf8e5, 0x6a23, 0xb52f, 0x8838, 0xb6d4, 0x5279, 0xf80e, 0xa450,
           0x13ec, 0x916f, 0x8edd, 0x0162, 0x9350, 0x9f74, 0xe1e7, 0x2719);
  scalar = 5383;
  asm volatile("vwmulu.vx v24, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e32, m8);
  VCMP_U32(8, v24, 0x14719743, 0x08b7c5f5, 0x0ee1cf49, 0x0b305188, 0x0f0463cc,
  ...
  asm volatile("vwmulu.vx v24, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_U64(9, v24, 0x004bad6117b0b36c, 0x0042e58b237456c4, 0x005da736d67d2bc3,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vwmulu.vx v24, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e16, m8);
  VCMP_U16(10, v24, 0, 0x0055, 0, 0x04b5, 0, 0x00a5, 0, 0x0127, 0, 0x04c9, 0,
  ...
  asm volatile("vwmulu.vx v24, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e32, m8);
  VCMP_U32(11, v24, 0, 0x08b7c5f5, 0, 0x0b305188, 0, 0x06c62e4f, 0, 0x0d7f0e30,
  ...
  asm volatile("vwmulu.vx v24, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_U64(12, v24, 0, 0x0042e58b237456c4, 0, 0x005ab48c2ee15fe2, 0,

...
void TEST_CASE1(void) {
  VSET(16, e8, m8);
  VLOAD_8(v8, 0x37, 0x4e, 0x9a, 0x08, 0x12, 0xfd, 0xa4, 0x21, 0x44, 0x58, 0x5a,
          0xa9, 0x1d, 0x5e, 0xd4, 0x8e);
  VLOAD_8(v16, 0x60, 0x5b, 0x0e, 0x78, 0x67, 0xf4, 0xd3, 0x0f, 0x75, 0x34, 0xc3,
          0xb1, 0x62, 0x42, 0xa9, 0x75);
  asm volatile("vwmulsu.vv v24, v8, v16");
  VSET(16, e16, m8);
  VCMP_I16(1, v24, 0x14a0, 0x1bba, 0xfa6c, 0x03c0, 0x073e, 0xfd24, 0xb42c,
           0x01ef, 0x1f14, 0x11e0, 0x448e, 0xc3d9, 0x0b1a, 0x183c, 0xe2f4,
           0xcbe6);

  VSET(16, e16, m8);
  VLOAD_16(v8, 0xba33, 0x3a22, 0x9f52, 0x0c6a, 0xcb67, 0x790c, 0x1a85, 0x958e,
           0xe967, 0x52b6, 0xa453, 0xe306, 0x3c91, 0x0309, 0xcbad, 0x9b78);
  VLOAD_16(v16, 0x84ef, 0xf522, 0x6224, 0x6e02, 0xeedb, 0x5a1f, 0x98d7, 0xa498,
           0x7a66, 0xdc69, 0xd88b, 0xa611, 0x5a08, 0x6836, 0x9130, 0x85be);
  asm volatile("vwmulsu.vv v24, v8, v16");
  VSET(16, e32, m8);
  VCMP_I32(2, v24, 0xdbc1219d, 0x37aa4284, 0xdaefcb88, 0x0555a4d4, 0xceecc31d,
...
void TEST_CASE2(void) {
  ...
  VSET(16, e16, m8);
  VCMP_I16(4, v24, 0, 0x1bba, 0, 0x03c0, 0, 0xfd24, 0, 0x01ef, 0, 0x11e0, 0,
  ...
  asm volatile("vwmulsu.vv v24, v8, v16, v0.t");
  VSET(16, e32, m8);
  VCMP_I32(5, v24, 0, 0x37aa4284, 0, 0x0555a4d4, 0, 0x2a9ce074, 0, 0xbb8fc450,
...
void TEST_CASE3(void) {
  VSET(16, e8, m8);
  VLOAD_8(v8, 0x16, 0x39, 0x0d, 0xcb, 0x02, 0x2b, 0xcd, 0x30, 0xec, 0x03, 0x18,
          0x78, 0xec, 0xba, 0xf8, 0x49);
  uint64_t scalar = 5;
  asm volatile("vwmulsu.vx v24, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e16, m8);
  VCMP_I16(7, v24, 0x006e, 0x011d, 0x0041, 0xfef7, 0x000a, 0x00d7, 0xff01,
           0x00f0, 0xff9c, 0x000f, 0x0078, 0x0258, 0xff9c, 0xfea2, 0xffd8,
           0x016d);

  VSET(16, e16, m8);
  VLOAD_16(v8, 0x602f, 0x1b08, 0xfdd6, 0x7e53, 0x59f7, 0x70f1, 0x8a33, 0x5d93,
           0x02a3, 0x9f70, 0x3919, 0x8f2b, 0xc9d3, 0x1b65, 0x15bd, 0xf8be);
  scalar = 5383;
  asm volatile("vwmulsu.vx v24, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e32, m8);
  VCMP_I32(8, v24, 0x07e67c49, 0x02386538, 0xffd27eda, 0x0a604345, 0x0763b8c1,
  ...
  asm volatile("vwmulsu.vx v24, v8, %[A]" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_I64(9, v24, 0x002ded2f109a4958, 0xfff8153a6c2ccdf4, 0xffd96e55a002304e,
...
void TEST_CASE4(void) {
  ...
  VLOAD_8(v0, 0xAA, 0xAA);
  VCLEAR(v24);
  asm volatile("vwmulsu.vx v24, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e16, m8);
  VCMP_I16(10, v24, 0, 0x011d, 0, 0xfef7, 0, 0x00d7, 0, 0x00f0, 0, 0x000f, 0,
  ...
  asm volatile("vwmulsu.vx v24, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e32, m8);
  VCMP_I32(11, v24, 0, 0x02386538, 0, 0x0a604345, 0, 0x0946db97, 0, 0x07af9e05,
  ...
  asm volatile("vwmulsu.vx v24, v8, %[A], v0.t" ::[A] "r"(scalar));
  VSET(16, e64, m8);
  VCMP_I64(12, v24, 0, 0xfff8153a6c2ccdf4, 0, 0x0009f73117dc67d2, 0,

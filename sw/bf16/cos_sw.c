/*  cos_sw.c – Cody-Waite + polynomial COS for BF16
 *
 *  Algorithm: quadrant reduction via k = round(x * 2/π), then polynomial
...
int main(void) {
    ...
    if (cid == 0) {
        ...
        check_bf16(g_out, outCos, N, "COS_SW");
    }
